...
document.getElementById('googleForm').addEventListener('submit', function (e) {
    ...
    fetch("https://docs.google.com/forms/d/e/1FAIpQLSc1vmIyugdTkV1J6VGFTZaF0uQnnVfARtnYBPeeCQJgmnLSow/formResponse", {
        method: "POST",
        body: formData,
        mode: "no-cors"
    }).then(() => {
        showToast("Form successfully submitted! 🎉");
        //document.getElementById('status').innerText = "Form successfully submitted!";
        this.reset();
    }).catch(() => {
